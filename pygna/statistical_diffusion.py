...
class DiffusionTest:
    ...
    def __init__(self, test_statistic, nodes, diffusion_matrix, weights_table, names_col = 'name', weights_col = 'stat',  diz={}):
    ...
    def get_null_distribution_mp(self, geneset_index, iter=100,n_proc=1):
        ...
        if n_proc==1:
            ...
            results = [p.apply_async(DiffusionTest.get_null_distribution, args=(self,geneset_index,n_trial)) for w in list(range(1,n_proc+1))]
    ...
    def get_null_distribution(self, geneset_index, n_samples):
        ...
        for i in range(n_samples):
            ...
            random_dist.append( self.test_statistic(self.diffusion_matrix, random_weights, geneset_index , self.diz, observed_flag=True) )
