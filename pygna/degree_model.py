...
class DegreeModel(object):
    ...
    def create_graph(self):
        ...
        while reject:
            graph = generate_graph_vip(self.n_nodes, self.n_vip, network_prob=self.network_prob, vip_prob=self.vip_prob,  node_names=self.nodes)
...
def generate_vip_network(output_folder,
    ...
    dm=DegreeModel(network_prob=network_prob, vip_prob=vip_prob, n_nodes=n_nodes, vip_percentage=vip_percentage)
