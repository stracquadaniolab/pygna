...
class KSTest:
    ...
    def apply_test(self, geneset):
        ...
        if mapped_geneset==0:
            ...
            observed = self.__distribution(self.__network, mapped_geneset, self.__diz, observed_flag=True)
            baseline = self.__distribution(self.__network, others, self.__diz, observed_flag=True)
